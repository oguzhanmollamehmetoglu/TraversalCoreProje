...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240202210048_mig_add_comment_AppUser_Reservation_relation")]
    partial class mig_add_comment_AppUser_Reservation_relation
    {
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Comment", b =>
                {
                    ...
                    b.Property<int>("DestinationDestiantionID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DestinationDestiantionID");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Reservation", b =>
                {
                    ...
                    b.Property<int>("NewDestiantionID")
                        .HasColumnType("int");

                    b.Property<int>("NewDestinationDestiantionID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NewDestinationDestiantionID");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Comment", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Concrete.Destination", "Destination")
                        .WithMany("Comments")
                        .HasForeignKey("DestinationDestiantionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Reservation", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Concrete.Destination", "NewDestination")
                        .WithMany("Reservations")
                        .HasForeignKey("NewDestinationDestiantionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
